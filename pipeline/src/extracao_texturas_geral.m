function extracao_texturas_geral
...
for i=6:10
    ...
    nome_mask1 = strcat(dir_mascaras,paciente,'_mask_1.bmp');
    nome_mask2 = strcat(dir_mascaras,paciente,'_mask_2.bmp');
    nome_mask3 = strcat(dir_mascaras,paciente,'_mask_3.bmp');
