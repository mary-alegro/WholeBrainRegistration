...
treino = ones(size(mask((mask == 242)),1),17);
labels = ones(size(mask((mask == 242)),1),1); %one-class -> tecido normal = 1

treino(:,1) = img1(mask == 242);
treino(:,2) = img2(mask == 242);
treino(:,3) = img3(mask == 242);
treino(:,4) = img4(mask == 242);
treino(:,5) = img5(mask == 242);
treino(:,6) = img6(mask == 242);
treino(:,7) = img7(mask == 242);
treino(:,8) = img8(mask == 242);
treino(:,9) = img9(mask == 242);
treino(:,10) = img10(mask == 242);
treino(:,11) = img11(mask == 242);
treino(:,12) = img12(mask == 242);
treino(:,13) = img13(mask == 242);
treino(:,14) = img14(mask == 242);
treino(:,15) = img15(mask == 242);
treino(:,16) = img16(mask == 242);
treino(:,17) = img(mask == 242);
...
teste = ones(size(mask(mask ~= 255),1),17);
