function mat_rs = resize_matrix(varargin)
%RESIZE     Resize a matrix.
%
% DESCRIPTION:
%       Resize a matrix to a given size using interp2 (2D) or interp3 (3D).
%
% USAGE:
